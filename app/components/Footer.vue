      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <div class="flex gap-4 mt-6">
            <a href="https://www.instagram.com/jimbaranyogastudio" target="_blank" class="text-yoga-secondary hover:text-yoga-accent transition-colors">
            ...
            <a href="https://wa.me/+6287776336882" target="_blank" class="text-gray-400 hover:text-yoga-accent transition-colors">
        ...
        <!-- Quick Links -->
        <div>
          <h4 class="font-bold text-lg mb-6 font-heading text-yoga-light">Links</h4>
          <ul class="space-y-3 text-sm text-yoga-secondary font-body">
            <li><a href="#" class="hover:text-yoga-accent transition-colors">About</a></li>
            <li><a href="#" class="hover:text-yoga-accent transition-colors">Classes</a></li>
            <li><a href="#" class="hover:text-yoga-accent transition-colors">Pricing</a></li>
            <li><a href="#" class="hover:text-yoga-accent transition-colors">Contact</a></li>
          </ul>
        </div>

        <!-- Classes -->
        <!-- <div>
          <h4 class="font-bold text-lg mb-6 font-heading text-yoga-light">Classes</h4>
          <ul class="space-y-3 text-sm text-yoga-secondary font-body">
            <li><a href="#" class="hover:text-yoga-accent transition-colors">Morning Flow</a></li>
            <li><a href="#" class="hover:text-yoga-accent transition-colors">Hatha Yoga</a></li>
            <li><a href="#" class="hover:text-yoga-accent transition-colors">Power Yoga</a></li>
            <li><a href="#" class="hover:text-yoga-accent transition-colors">Restorative</a></li>
          </ul>
        </div> -->
        ...
        <div>
          ...
          <ul class="space-y-4 text-sm text-yoga-secondary">
            ...
            <li>
              ...
              <p>Jl.Batur Raya No.9 Lt.3, Jimbaran, Kec. Kuta Sel., Kabupaten Badung, Bali 80361</p>
            </li>
          </ul>
        </div>
      </div>
