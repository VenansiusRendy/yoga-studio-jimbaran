	...
	<footer class="bg-yoga-dark text-yoga-light py-16 px-4">
		<div class="max-w-6xl mx-auto">
			<div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
				...
				<div>
					...
					<div class="flex gap-4 mt-6">
						<a
							href="https://www.instagram.com/jimbaran.wellnesscollective/"
							target="_blank"
						...
						<a
							:href="whatsappLink"
							target="_blank"
							class="text-gray-400 hover:text-yoga-accent transition-colors"
						>
				...
				<div>
					...
					<ul class="space-y-3 text-sm text-yoga-secondary font-body">
						<li>
							<a href="#why" class="hover:text-yoga-accent transition-colors"
								>Why Us</a
							>
						</li>
						<li>
						...
						<li>
							<a href="#book" class="hover:text-yoga-accent transition-colors"
								>Book</a
							>
						</li>
						<li>
			...
			<div class="border-t border-yoga-secondary pt-8">
				<div
					class="flex flex-col md:flex-row justify-between items-center text-sm text-yoga-secondary"
				>
					<p class="text-xs">
