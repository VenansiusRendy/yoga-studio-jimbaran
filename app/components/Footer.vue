      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
        ...
        <div>
          ...
          <div class="flex gap-4 mt-6">
            <a href="https://instagram.com" target="_blank" class="text-yoga-secondary hover:text-yoga-accent transition-colors">
            ...
            <a href="https://wa.me/62812345678" target="_blank" class="text-gray-400 hover:text-yoga-accent transition-colors">
