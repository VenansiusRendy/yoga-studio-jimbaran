<template>
	<footer class="bg-yoga-dark text-yoga-light py-16 px-4">
		<div class="max-w-6xl mx-auto">
			<div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
				...
				<div>
					<div class="flex items-center gap-2 mb-4">
						...
						<span class="font-bold">Jimbaran Wellness Collective</span>
					</div>
					<p class="text-yoga-secondary text-sm leading-relaxed">
						A welcoming space in Jimbaran where people come to move, learn, and
						reconnect through community-led activities.
					</p>
					<div class="flex gap-4 mt-6">
						<a href="https://www.instagram.com/jimbaran.wellnesscollective/" target="_blank"
							class="text-yoga-secondary hover:text-yoga-accent transition-colors">
						...
						<a :href="whatsappLink" target="_blank" class="text-gray-400 hover:text-yoga-accent transition-colors">
				...
				<!-- Quick Links -->
				<div>
					<h4 class="font-bold text-lg mb-6 font-heading text-yoga-light">
						Quick Links
					</h4>
					<ul class="space-y-3 text-sm text-yoga-secondary font-body">
						<li>
							<a href="#why" class="hover:text-yoga-accent transition-colors">Why Us</a>
						</li>
						<li>
							<a href="#activities" class="hover:text-yoga-accent transition-colors">Activities</a>
						</li>
						<!-- <li>
							<a
								href="#schedule"
								class="hover:text-yoga-accent transition-colors"
								>Schedule</a
							>
						</li> -->
						<li>
							<a href="#book" class="hover:text-yoga-accent transition-colors">Book</a>
						</li>
						<li>
							<a href="#contact" class="hover:text-yoga-accent transition-colors">Contact</a>
						</li>
					</ul>
				</div>

				<div>
					<h4 class="font-bold text-lg mb-6 text-yoga-light">Info</h4>
					<ul class="space-y-4 text-sm text-yoga-secondary">
						<li>
							<p class="font-semibold text-yoga-light mb-1">Hours</p>
							<p>Monday – Sunday: 09:00 – 17:00</p>
						</li>
						<li>
							<p class="font-semibold text-yoga-light mb-1">Address</p>
							<p>
								Jl.Batur Raya No.9 Lt.3, Jimbaran, Kec. Kuta Sel., Kabupaten
								Badung, Bali 80361
							</p>
						</li>
					</ul>
			...
			<div class="border-t border-yoga-secondary pt-8">
				<div class="flex flex-col md:flex-row justify-between items-center text-sm text-yoga-secondary">
					<p class="text-xs">
						© 2025 <br />Jimbaran Wellness Collective. <br />All rights
						reserved.
					</p>
					<p class="mt-4 md:mt-0 text-xs">
						Previously presented as a yoga-focused concept, this platform is now
						part of Jimbaran Wellness Collective, where yoga is one of several
						community activities supported by NUI Healthy Food.
					</p>
				</div>
			</div>
		</div>
