	...
	<header class="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
		<nav class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
			...
			<div class="flex items-center gap-3">
				...
				<span class="font-semibold text-yoga-dark text-sm md:text-base hidden sm:inline">Jimbaran Wellness
					Collective</span>
			</div>

			<!-- Desktop Nav -->
			<div class="hidden md:flex items-center gap-8">
				<a href="#why" class="text-sm text-gray-600 hover:text-yoga-primary transition-colors">Why Us
				</a>
				<a href="#activities" class="text-sm text-gray-600 hover:text-yoga-primary transition-colors">Activities</a>
				<!-- <a
					href="#schedule"
					class="text-sm text-gray-600 hover:text-yoga-primary transition-colors"
					>Schedule</a
				> -->
				<a href="#book" class="text-sm text-gray-600 hover:text-yoga-primary transition-colors">Book</a>
				<a href="#contact" class="text-sm text-gray-600 hover:text-yoga-primary transition-colors">Contact</a>
			</div>

			<!-- CTA Button -->
			<a :href="whatsappLink" target="_blank" rel="noopener noreferrer"
				class="px-4 py-2 bg-yoga-accent text-white text-sm rounded-lg hover:bg-yoga-primary transition-colors font-medium flex items-center gap-2">
