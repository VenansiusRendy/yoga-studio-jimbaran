  ...
  <header class="sticky top-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-100">
    <nav class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
      ...
      <div class="flex items-center gap-3">
        <div class="w-10 h-10 rounded-full bg-gradient-to-br from-yoga-primary-green to-yoga-earth flex items-center justify-center">
          <span class="font-bold text-white text-xs leading-none" style="font-size: 0.65rem; letter-spacing: -0.5px;">JYS</span>
        </div>
        <span class="font-semibold text-yoga-ocean-dark text-sm md:text-base hidden sm:inline">Jimbaran Yoga</span>
      </div>
      
      <!-- Desktop Nav -->
      <div class="hidden md:flex items-center gap-8">
        <a href="#" class="text-sm text-gray-600 hover:text-yoga-primary-green transition-colors">About</a>
        <a href="#" class="text-sm text-gray-600 hover:text-yoga-primary-green transition-colors">Classes</a>
        <a href="#" class="text-sm text-gray-600 hover:text-yoga-primary-green transition-colors">Pricing</a>
        <a href="#" class="text-sm text-gray-600 hover:text-yoga-primary-green transition-colors">Contact</a>
      </div>
